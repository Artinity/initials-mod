package nl.artinity.initials.factories;
...
public class PotionFactory {
	...
	public static final int STRENGHT = 5;
	...
	public static PotionEffect getNewPotionEffect(int potionID, int seconds, int modifier) {
		return new PotionEffect(Potion.getPotionById(potionID), seconds*20, modifier);
	}
	
	public static PotionEffect getNewPotionEffect(int potionID, int seconds) {
		return new PotionEffect(Potion.getPotionById(potionID), seconds*20, 0);
	}
}
